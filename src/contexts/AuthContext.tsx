...
// //       // 3. Insert the new profile in the profiles table
...
// //           role: role as any,
// //           avatar_url: '', // Add a default avatar if you like
// //         },
// //       ]);
...
// //       //   throw new Error(`Database error saving profile: ${profileError.message}`);
// //       // }
// //       if (profileError) {
...
//   // Redirect to login if not authenticated and path is private
//   useEffect(() => {
//     if (!loading && !user && !publicPaths.includes(location.pathname)) {
//       navigate('/login');
//     }
