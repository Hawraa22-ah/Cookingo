                ...
                >
                  ...
                  <button
                    ...
                    style={{
                      padding: '4px 12px',
                      fontSize: '0.75rem',
                      background: n.is_read ? '#c2fad8' : '#4386ff',
                      color: n.is_read ? '#198754' : '#fff',
                      border: 'none',
                      borderRadius: 4,
                      cursor: n.is_read ? 'default' : 'pointer',
                      fontWeight: 500,
                      boxShadow: n.is_read ? 'none' : '0 1px 2px rgba(67,134,255,0.08)',
                      transition: 'background 0.15s',
                    }}
                  >
                    {n.is_read ? 'delivered' : 'Done'}
                  </button>
                </li>
              ))}
            </ul>
            ...
            >
              ...
              <button
                ...
                style={{
                  padding: '6px 16px',
                  fontSize: '0.9rem',
                  background: allRead ? '#c2fad8' : '#4386ff',
                  color: allRead ? '#198754' : '#fff',
                  border: 'none',
                  borderRadius: 4,
                  cursor: allRead ? 'default' : 'pointer',
                  fontWeight: 600,
                  boxShadow: allRead ? 'none' : '0 1px 2px rgba(67,134,255,0.08)',
                  transition: 'background 0.15s',
