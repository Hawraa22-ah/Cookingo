...
// //       toast.success('Removed from favorites');
// //     } else {
// //       const payload = { user_id: currentUserId, recipe_id: recipeId };
// //       console.log('🧪 Inserting favorite:', payload);
...
// //     await supabase.rpc('update_favorite_count', { recipe_id_input: recipeId });
// //   } catch (err: any) {
// //     console.error('❌ Unexpected error in handleFavorite:', err.message || err);
...
//     try {
//       if (isFavorite) {
//         // ← delete from the same `favorites_recipes` table
//         const { error } = await supabase
//           .from('favorites_recipes')
//           .delete()
//           .eq('user_id', currentUserId)
