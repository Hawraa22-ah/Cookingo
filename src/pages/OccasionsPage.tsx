...
export default function OccasionsPage() {
  ...
  const handleSubmit = async () => {
    ...
    // 2) insert a notification so it shows up in NotificationsPage
    const notifMessage = `Your request for ${quantity}× ${foodType} on ${date} has been submitted.`;
  ...
  return (
    <div className="px-6 py-8 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold mb-8">Occasions & Special Menuls</h1>
