/*
  ...
  1. New Tables
    - recipes
      ...
      - ingredients (jsonb, default: empty array)
      - instructions (jsonb, default: empty array)
  ...
  2. Security
    ...
    - Authenticated chefs can create/update/delete their own recipes

  3. Initial Data
    - Seed one sample recipe
*/
